...
# nest.js-company_manager

This project is a basic system for managing users and their associated companies. It allows for user registration, checking for duplicate emails, and associating users with companies.
...
- **Company Management**:
  - Company registration linked to users

## Table of Content

- [nest.js-company\_manager](#nestjs-company_manager)
  - [Features](#features)
...
1. Clone the repository from GitHub:
   ...
   ```shell
   git clone https://github.com/saeedNW/nest.js-company_manager.git
   ```

2. Navigate to the project directory:

   ```shell
   cd nest.js-company_manager
   ```
